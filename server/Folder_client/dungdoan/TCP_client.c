...
int main(int argc, char * argv[]){
	...
	int msg_len, bytes_sent, bytes_received,number_online;
	char *opcode ,*status,*number;
				...
				if(strcmp(buff,"16") == 0){
					...
					while (1){
						...
						case 1:
							...
							opcode = strtok(buff, "|");
							number = strtok(NULL,"|");
							number_online = atoi(number);
							printf("Danh sach nguoi dung dang online!!!\n");
							printf("\n*****************************\n");
						...
						case 2:
							...
							if(receive_image(client_sock,PATH) == 1){
								printf(FG_GREEN "[+] Nhan anh thanh cong !!!!\n" NORMAL);
							}
							break;
						case 3:
